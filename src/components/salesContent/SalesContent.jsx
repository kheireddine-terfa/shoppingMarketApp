        ...
        <section className="w-1/2 p-4 mr-10">
          {selectedCategory === null ? (
            <div className="grid grid-cols-3 gap-5 gap-y-12">
              <Category
                title="Fruits"
                imageSrc={require('./image.jpeg')}
                onClick={() => handleCategoryClick('Fruits')}
              />
              <Category
                title="Légumes"
                imageSrc={require('./veg.jpeg')}
                onClick={() => handleCategoryClick('Vegetables')}
              />
              <Category
                title="Noisettes"
                imageSrc={require('./nois.jpeg')}
                onClick={() => handleCategoryClick('Nuts')}
              />
              <Category
                title="Autres"
                imageSrc={require('./oth.jpeg')}
